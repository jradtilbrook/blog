<template>
  <div class="font-sans leading-normal flex flex-col min-h-screen">
    <header class="border-t-14 border-blue-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div class="uppercase tracking-wide font-bold">jradtilbrook</div>
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-row items-center py-8">
